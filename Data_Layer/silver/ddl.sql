...
-- Índices para melhorar performance de consultas (Apontando para silver.acd)
...
-- Comentários na tabela (Apontando para silver.acd)
COMMENT ON TABLE "silver"."acd" IS 'Tabela consolidada (One Big Table) contendo dados tratados de acidentes aeronáuticos no Brasil. Armazenada no schema SILVER.';
